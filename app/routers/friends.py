...
def _calculate_ranks_if_completed(db: Session, challenge: Challenge):
    ...
    # NOTE: This function requires the 'rank' column in challenge_participants table
    # Run migration: ALTER TABLE challenge_participants ADD COLUMN rank INTEGER;
    # Then uncomment the code below and the rank field in models/challenges.py
